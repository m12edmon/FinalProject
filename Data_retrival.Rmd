...
is.Date(All_fc$ActivityStartDate)
...
# Format ANOVA as aov
all_fc.anova <- aov(data = fecal_total, County_Code ~ FecalValue)
summary(all_fc.anova)
#there is a significant p value (P=0.0285)

# Format ANOVA as lm
all_fc.lm <- lm(data = fecal_total, County_Code ~ FecalValue)
summary(all_fc.lm)
#there is a significant difference. P value 0.0285. Meaning there is a relationship between N.C. counties and fecal coliform
