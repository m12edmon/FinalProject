...
Figure_5 <- ggplot(fecal_total_processed, aes(x=County_Code, y=FecalValue, color = County_Code))+
  geom_jitter(alpha -0.2)+
  scale_color_viridis_d()+
  labs(x = "N.C. County", y = expression("Fecal coliforms filtered to 0.7 " * mu *m *  " (cfu / 100 ml)"))
print(Figure_5 + ggtitle("Exploratory Scatter Plot"))
...
Pitt_biologicalresults <-read_csv("./Pitt_biologicalresults.csv")
Pitt_station <-read_csv("./Pitt_station.csv")
...
```{r, echo=FALSE,error=FALSE, message=FALSE, warning=FALSE, fig.cap="Figure 2. Fecal Coliform Concentrations in Surface Waters by County"}
...
```{r, echo=FALSE,error=FALSE, message=FALSE, warning=FALSE, fig.cap="Figure 3: Exceeded Fecal Coliform Concentrations in Surface Waters by County"}
...
```{r, echo=FALSE,error=FALSE, message=FALSE, warning=FALSE, fig.cap="Figure 4: Recorded Fecal Coliform Samples Per County"}
#exploratory bar graph
explore.bar.graph <-ggplot(fecal_total, aes(x =County_Code)) +
  geom_bar()+
  labs(x = "N.C. County", y= "Samples Collected")+
...
```{r, echo=FALSE,error=FALSE, message=FALSE, warning=FALSE, fig.cap="Figure 5. Box Plot of Fecal Coliform Data across N.C. Counties"}
#exploratory box plot
explore.box <- ggplot(fecal_total) +
  geom_boxplot(aes(x = County_Code, y = FecalValue, color= County_Code))+
  scale_color_viridis_d()+
...
```{r, echo=FALSE,error=FALSE, message=FALSE, warning=FALSE, fig.cap="Figure 6. Scatter Plot Representation of Fecal Coliform Concentrations in N.C. Counties"}
#exploratory scatter plot
#explore.scatter.county <-ggplot(fecal_total) +
#  geom_point(aes(x = County_Code, y = FecalValue, color = County_Code))+
#  scale_color_viridis_d(option = "magma")+
...
```{r, echo=FALSE,error=FALSE, message=FALSE, warning=FALSE, fig.cap="Figure 7. Recorded Fecal Coliform Concentrations from 1970-2018"}
...
```{r, echo=FALSE,error=FALSE, message=FALSE, warning=FALSE, fig.cap="Figure 8. Exploratory plot of recorded fecal coliform concentations in Greene County, N.C."}
...
```{r, echo=FALSE,error=FALSE, message=FALSE, warning=FALSE, fig.cap="FIgure 9. Exploratory plot of recorded fecal coliform concentations in Greene County, N.C. from 1970- 2018"}
...
```{r, echo=FALSE,error=FALSE, message=FALSE, warning=FALSE, fig.cap="Figure 10. Exploratory plot of recorded seasonal fecal coliform concentations in Greene County, N.C."}
Greene.coli.seasons <- ggplot(Greene.coli.monthly.summaries, aes(x = month)) +
  geom_ribbon(aes(ymin = quant25, ymax = quant75), alpha = 0.3) +
  geom_line(aes(y = Median)) +
  geom_hline(yintercept=200, linetype="dashed", color = "blue")+
...
```{r, echo=FALSE,error=FALSE, message=FALSE, warning=FALSE, fig.cap="Figure 11. Exploratory plot of recorded fecal coliform concentations in Pitt County, N.C."}
Pitt.F.coli.plot <- ggplot(Pitt_fecal, aes(x = Date)) +
  geom_line(aes(y = Fecal_Coliform_Value)) +
  ylim(0, 10200)+
  labs(x = "Year", 
...
```{r, echo=FALSE,error=FALSE, message=FALSE, warning=FALSE, fig.cap="Figure 12. Exploratory plot of recorded fecal coliform concentations in Pitt County, N.C. from 1970- 2018"}
Pitt.coli.years <- ggplot(Pitt.coli.year.summaries, aes(x = year)) +
  geom_ribbon(aes(ymin = quant25, ymax = quant75), alpha = 0.3) +
  geom_line(aes(y = Median)) +
  geom_hline(yintercept=200, linetype="dashed", color = "blue")+
...
```{r, echo=FALSE,error=FALSE, message=FALSE, warning=FALSE, fig.cap="Figure 13. Exploratory plot of recorded seasonal fecal coliform concentations in Pitt County, N.C"}
Pitt.coli.seasons <- ggplot(Pitt.coli.monthly.summaries, aes(x = month)) +
  geom_ribbon(aes(ymin = quant25, ymax = quant75), alpha = 0.3) +
  geom_line(aes(y = Median)) +
  geom_hline(yintercept=200, linetype="dashed", color = "blue")+
...
```{r, echo=FALSE,error=FALSE, message=FALSE, warning=FALSE, fig.cap="Figure 14. Exploratory plot of recorded fecal coliform concentations in Duplin County, N.C."}
Duplin.F.coli.plot <- ggplot(Duplin_fecal, aes(x = Date)) +
  geom_line(aes(y = Fecal_Coliform_Value)) +
  ylim(0, 10200)+
  labs(x = "Year", 
...
```{r, echo=FALSE,error=FALSE, message=FALSE, warning=FALSE, fig.cap="Figure 15. Exploratory plot of recorded seasonal fecal coliform concentations in Duplin County, N.C"}
...
```{r, echo=FALSE,error=FALSE, message=FALSE, warning=FALSE, fig.cap="Figure 16. Exploratory plot of recorded seasonal fecal coliform concentations in Duplin County, N.C"}
Duplin.coli.seasons <- ggplot(Duplin.coli.monthly.summaries, aes(x = month)) +
  geom_ribbon(aes(ymin = quant25, ymax = quant75), alpha = 0.3) +
  geom_line(aes(y = Median)) +
  geom_hline(yintercept=200, linetype="dashed", color = "blue")+
...
```{r, echo=FALSE,error=FALSE, message=FALSE, warning=FALSE, fig.cap="Figure 17. Exploratory plot of recorded seasonal fecal coliform concentations in Lenoir County, N.C"}
Lenoir.F.coli.plot <- ggplot(Lenoir_fecal, aes(x = Date)) +
  geom_line(aes(y = Fecal_Coliform_Value)) +
  ylim(0, 10200)+
  labs(x = "Year", 
...
```{r, echo=FALSE,error=FALSE, message=FALSE, warning=FALSE, fig.cap="Figure 18. Exploratory plot of recorded fecal coliform concentations in Lenoir County, N.C. from 1970- 2018"}
Lenoir.coli.years <- ggplot(Lenoir.coli.year.summaries, aes(x = year)) +
  geom_ribbon(aes(ymin = quant25, ymax = quant75), alpha = 0.3) +
  geom_line(aes(y = Median)) +
  geom_hline(yintercept=200, linetype="dashed", color = "blue")+
...
```{r, echo=FALSE,error=FALSE, message=FALSE, warning=FALSE, fig.cap="Figure 19. Exploratory plot of recorded seasonal fecal coliform concentations in Lenoir County, N.C"}
Lenoir.coli.seasons <- ggplot(Lenoir.coli.monthly.summaries, aes(x = month)) +
  geom_ribbon(aes(ymin = quant25, ymax = quant75), alpha = 0.3) +
  geom_line(aes(y = Median)) +
  geom_hline(yintercept=200, linetype="dashed", color = "blue")+
...
```{r, echo=FALSE,error=FALSE, message=FALSE, warning=FALSE, fig.cap="Figure 20. Exploratory plot of recorded fecal coliform concentations in Sampson County, N.C."}
Sampson.F.coli.plot <- ggplot(Sampson_fecal, aes(x = Date)) +
  geom_line(aes(y = Fecal_Coliform_Value)) +
  ylim(0, 10200)+
  labs(x = "Year", 
...
```{r, echo=FALSE,error=FALSE, message=FALSE, warning=FALSE, fig.cap="Figure 21. Exploratory plot of recorded fecal coliform concentations in Sampson County, N.C. from 1970- 2018"}
Sampson.coli.years <- ggplot(Sampson.coli.year.summaries, aes(x = year)) +
  geom_ribbon(aes(ymin = quant25, ymax = quant75), alpha = 0.3) +
  geom_line(aes(y = Median)) +
  geom_hline(yintercept=200, linetype="dashed", color = "blue")+
...
```{r, echo=FALSE,error=FALSE, message=FALSE, warning=FALSE, fig.cap="Figure 22. Exploratory plot of recorded seasonal fecal coliform concentations in Sampson County, N.C"}
Sampson.coli.seasons <- ggplot(Sampson.coli.monthly.summaries, aes(x = month)) +
  geom_ribbon(aes(ymin = quant25, ymax = quant75), alpha = 0.3) +
  geom_line(aes(y = Median)) +
  geom_hline(yintercept=200, linetype="dashed", color = "blue")+
...
```{r, echo=FALSE,error=FALSE, message=FALSE, warning=FALSE, fig.cap="Figure 23. Exploratory plot of recorded fecal coliform concentations in Wayne County, N.C."}
...
```{r, echo=FALSE,error=FALSE, message=FALSE, warning=FALSE, fig.cap="Figure 24. Exploratory plot of recorded fecal coliform concentations in Wayne County, N.C. from 1970- 2018"}
Wayne.coli.years <- ggplot(Wayne.coli.year.summaries, aes(x = year)) +
  geom_ribbon(aes(ymin = quant25, ymax = quant75), alpha = 0.3) +
  geom_line(aes(y = Median)) +
  geom_hline(yintercept=200, linetype="dashed", color = "blue")+
...
```{r, echo=FALSE,error=FALSE, message=FALSE, warning=FALSE, fig.cap="Figure 25. Exploratory plot of recorded seasonal fecal coliform concentations in Wayne County, N.C"}
Wayne.coli.seasons <- ggplot(Wayne.coli.monthly.summaries, aes(x = month)) +
  geom_ribbon(aes(ymin = quant25, ymax = quant75), alpha = 0.3) +
  geom_line(aes(y = Median)) +
  geom_hline(yintercept=200, linetype="dashed", color = "blue")+
...
```{r, echo=FALSE,error=FALSE, message=FALSE, warning=FALSE, fig.cap="Figure 26. QQ plot results"}
#check to see if raw data is normally distributed
...
```{r, echo=FALSE,error=FALSE, message=FALSE, warning=FALSE, fig.cap="Figure 27. Linear model of ANOVA"}
# ANOVA is robust against departures from normality.
plot(all_fc.lm)
```
...
```{r, echo=FALSE,error=FALSE, message=FALSE, warning=FALSE, fig.cap="Figure 28. Box Plot of the distribution of the data"}
...
Case studies were conducted for six counties in North Carolina that have the highest ratio of permitted swine CAFOs in the state. Time series graphs were created to assess emerging trends in fecal coliform concentrations across season and across the 48 year time frame (Figure 30). 
